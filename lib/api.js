...
/* 取老师带的所有班级 */
/* 入参BasicParameterData */
/* 出参BasicParameterData */
FetchUserIDsync : function(data,_success,_error)
{
...
{
	return this.callfunc("FetchUserID",true,data,_success,_error);
},
/* 取获奖信息 */
/* 入参BasicParameterData */
...
/* 入参LongData */
/* 出参VoidableData */
AddTestSchoolsync : function(data,_success,_error)
{
	return this.callfunc("AddTestSchool",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参LongData */
/* 出参VoidableData */
AddTestSchool : function(data,_success,_error)	
{
	return this.callfunc("AddTestSchool",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参LongData */
/* 出参VoidableData */
...
/* 取checklist特定学校的checklist定义 */
/* 入参BasicParameterData */
/* 出参FetchAdminClazzInfoData */
FetchAdminClazzInfosync : function(data,_success,_error)
{
	return this.callfunc("FetchAdminClazzInfo",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参BasicParameterData */
/* 出参FetchAdminClazzInfoData */
FetchAdminClazzInfo : function(data,_success,_error)	
{
	return this.callfunc("FetchAdminClazzInfo",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参CounselorClazzSchoolData */
/* 出参FetchAdminCounselorInfoData */
FetchAdminCounselorInfosync : function(data,_success,_error)
{
	return this.callfunc("FetchAdminCounselorInfo",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参CounselorClazzSchoolData */
/* 出参FetchAdminCounselorInfoData */
FetchAdminCounselorInfo : function(data,_success,_error)	
{
	return this.callfunc("FetchAdminCounselorInfo",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参StudentClazzSchoolData */
/* 出参FetchAdminStudentUserInfoData */
FetchAdminStudentUserInfosync : function(data,_success,_error)
{
	return this.callfunc("FetchAdminStudentUserInfo",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参StudentClazzSchoolData */
/* 出参FetchAdminStudentUserInfoData */
FetchAdminStudentUserInfo : function(data,_success,_error)	
{
	return this.callfunc("FetchAdminStudentUserInfo",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参LongData */
...
/* 入参LongData */
/* 出参clazzListData */
FetchSchoolssync : function(data,_success,_error)
{
	return this.callfunc("FetchSchools",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参LongData */
/* 出参clazzListData */
FetchSchools : function(data,_success,_error)	
{
	return this.callfunc("FetchSchools",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参LongData */
/* 出参FetchSchoolListData */
FetchSchoolssync : function(data,_success,_error)
{
	return this.callfunc("FetchSchools",false,data,_success,_error);
},
...
/* 发布系统信息 */
/* 入参PublishMessageData */
/* 出参VoidableData */
PublishMessagesync : function(data,_success,_error)
{
	return this.callfunc("PublishMessage",false,data,_success,_error);
},
/* 发布系统信息 */
/* 入参PublishMessageData */
/* 出参VoidableData */
PublishMessage : function(data,_success,_error)	
{
	return this.callfunc("PublishMessage",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参clazzData */
/* 出参VoidableData */
SaveClazzsync : function(data,_success,_error)
{
	return this.callfunc("SaveClazz",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参clazzData */
/* 出参VoidableData */
SaveClazz : function(data,_success,_error)	
{
	return this.callfunc("SaveClazz",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参CounselorData */
/* 出参VoidableData */
SaveCounselorsync : function(data,_success,_error)
{
	return this.callfunc("SaveCounselor",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参CounselorData */
/* 出参VoidableData */
SaveCounselor : function(data,_success,_error)	
{
	return this.callfunc("SaveCounselor",true,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参StudentUserData */
/* 出参VoidableData */
SaveStudentUsersync : function(data,_success,_error)
{
	return this.callfunc("SaveStudentUser",false,data,_success,_error);
},
/* 取checklist特定学校的checklist定义 */
/* 入参StudentUserData */
/* 出参VoidableData */
SaveStudentUser : function(data,_success,_error)	
{
	return this.callfunc("SaveStudentUser",true,data,_success,_error);
},
/* counselor check checklistitem */
/* 入参PageBasicParameterData */
/* 出参ConselorLastChecklistListData */
ConselorFetchlastChecklistsync : function(data,_success,_error)
{
	return this.callfunc("ConselorFetchlastChecklist",false,data,_success,_error);
},
/* counselor check checklistitem */
/* 入参PageBasicParameterData */
/* 出参ConselorLastChecklistListData */
ConselorFetchlastChecklist : function(data,_success,_error)	
{
	return this.callfunc("ConselorFetchlastChecklist",true,data,_success,_error);
},
/* counselor check checklistitem */
/* 入参ConselorRejectcheckData */
/* 出参VoidableData */
ConselorRejectcheckChecklistItemsync : function(data,_success,_error)
{
	return this.callfunc("ConselorRejectcheckChecklistItem",false,data,_success,_error);
},
/* counselor check checklistitem */
/* 入参ConselorRejectcheckData */
/* 出参VoidableData */
ConselorRejectcheckChecklistItem : function(data,_success,_error)	
{
	return this.callfunc("ConselorRejectcheckChecklistItem",true,data,_success,_error);
},
/* counselor check 分类 */
